<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="03_DetailsViewStyled.aspx.cs"
    Inherits="DataBindingSamples._07_DetailsViewStyled" %>
...
<body>
    ...
    <div>
        <%--AutoGenerateRows="True" позволяет контролу сформировать структуру на основе всех значений, которые возвращает источник данных--%>
